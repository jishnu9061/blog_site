@extends('layouts.admin-dashboard', ['title' => 'Edit Tag'])
@push('styles')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form form-horizontal" method="POST"
                action="{{ route('admin.tag.update', ['tag' => $tag->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-1 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('name')is-invalid @enderror"
                                    ...
                                    value="{{ old('description', $tag->description) }}" placeholder="Enter description"
